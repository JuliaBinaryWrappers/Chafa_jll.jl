...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Chafa_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("52a89005-cc63-50df-a748-7ef82af009e5"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Chafa", artifacts_toml) for e in artifacts["Chafa"]]
...
if best_platform === nothing
    @debug("Unable to load Chafa; unsupported platform $(triplet(platform_key_abi()))")
else
