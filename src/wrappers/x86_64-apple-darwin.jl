# Autogenerated wrapper script for Chafa_jll for x86_64-apple-darwin
...
JLLWrappers.@declare_library_product(libchafa, "@rpath/libchafa.0.dylib")
function __init__()
